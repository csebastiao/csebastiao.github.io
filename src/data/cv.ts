...
export const publications = [
	{
		...
		authors: "Adrien Savoyant, Clément Sebastiao, Olivier Margeat",
...
export const skills = [
	{
		...
		description: 'Proficient in Python, especially with networks and geospatial data. Used before (by decreasing order of proficiency): PostgreSQL, R, Matlab.',
	},
];
